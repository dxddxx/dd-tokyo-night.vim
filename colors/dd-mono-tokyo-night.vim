...
let s:gui0E        = 'bb9af7'
let s:gui0F        = '2ac3de'
let s:gui10        = '1a1b26' " 00
let s:gui11        = '1a1b26' " 00
let s:gui12        = 'f7768e' " 08
let s:gui13        = 'e0af68' " 0A
let s:gui14        = '73daca' " 0B
let s:gui15        = '7dcfff' " 0C
let s:gui16        = '7aa2f7' " 0D
let s:gui17        = 'bb9af7' " 0E
...
" Theme setup
let g:colors_name = 'dd-mono-tokyo-night'
...
" fixed by dxddxx
call <sid>hi('SpellBad',       '', '', '', '', 'underline', s:gui08)
call <sid>hi('SpellLocal',     '', '', '', '', 'underline', s:gui15)
call <sid>hi('SpellCap',       '', '', '', '', 'underline', s:gui16)
call <sid>hi('SpellRare',      '', '', '', '', 'underline', s:gui0E)
